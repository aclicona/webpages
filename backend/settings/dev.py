...
VITE_DEV_MODE = env.bool('VITE_DEV_MODE', default=True)
...
FRONTEND_HOST = env.str('FRONTEND_HOST', default='localhost:3000')

if FRONTEND_HOST is not None:
    FRONTEND_SCHEME = env.str('FRONTEND_SCHEME', default='http')
